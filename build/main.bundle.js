...
var PatricaTrieNodeBase = function () {
    ...
    _createClass(PatricaTrieNodeBase, [{
        ...
        key: '_toString',
        value: function _toString(Output) {
            var Child = void 0;
...
/* eslint-disable operator-linebreak */
var PatricaTrieNode = function (_PatricaTrieNodeBase) {
...
var PatricaTrieCollection = function (_PatricaTrieNodeBase) {
    ...
    _createClass(PatricaTrieCollection, [{
        ...
        key: 'merge',
        value: function merge(Collection) {}
    }, {
        key: 'isAEnd',
        value: function isAEnd() {
...
var PatricaTrieCollectionEx = function (_PatricaTrieCollectio) {
...
/* eslint-disable operator-linebreak */
var PatricaTrieNodeEx = function (_PatricaTrieNode) {
    ...
    _createClass(PatricaTrieNodeEx, [{
        ...
        value: function insertPreventOverwrite(Key, Value) {
            ...
            if (NewKeyLength === CurrentKeyLength && PrefixLength === CurrentKeyLength) {
                ...
                if (PrefixLength === CurrentKeyLength) {
                    ...
                    false === NewChild._importChildren(this._Children);
        ...
        key: '_toString',
        value: function _toString(ValueSerializer, Output) {
            var Value = void 0,
                Child = void 0;
        ...
        key: 'toString',
        value: function toString(ValueSerializer) {
            var Output = [];
...
var PatricaStaticTrieNode = function (_PatricaTrieNodeBase) {
...
/* eslint-disable operator-linebreak */
var PatricaStaticTrieNodeFx = function (_PatricaStaticTrieNod) {
...
var PatricaTrie = function (_PatricaTrieNode) {
...
var PatricaTrieEx = function (_PatricaTrieNodeEx) {
...
var PatricaTrieStatic = function (_PatricaStaticTrieNod) {
...
var PatricaStaticTrieEx = function (_PatricaStaticTrieNod) {
...
// import { PatricaTrie } from "./Patrica";
